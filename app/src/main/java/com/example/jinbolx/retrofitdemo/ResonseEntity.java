...
public class ResonseEntity extends Bean{

    public ResonseEntity(int error_code) {
    ...
    public ResonseEntity(int error_code, String reason,
            ResultBean result) {
        this.error_code = error_code;
        this.reason = reason;
        this.result = result;
    ...
    public int error_code=5;
    private String reason;
    private ResultBean result;

    private int getError_code() {
        return error_code;
    }
